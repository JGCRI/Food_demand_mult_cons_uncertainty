...
module_aglu_batch_ag_an_demand_input_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L203.SubregionalShares_ConsumerGroups <- get_data(all_data, "L203.SubregionalShares_ConsumerGroups")
    L203.DemandFunction_food <- get_data(all_data, "L203.DemandFunction_food")
    L203.DemandFunction_food_ConsumerGroups <- get_data(all_data, "L203.DemandFunction_food_ConsumerGroups")
    ...
    L203.DemandStapleParams_ConsumerGroups <- get_data(all_data, "L203.DemandStapleParams_ConsumerGroups")
    L203.DemandNonStapleParams_ConsumerGroups <- get_data(all_data, "L203.DemandNonStapleParams_ConsumerGroups")
    ...
    L203.StapleBaseService_ConsumerGroups <- get_data(all_data, "L203.StapleBaseService_ConsumerGroups")
    L203.NonStapleBaseService_ConsumerGroups <- get_data(all_data, "L203.NonStapleBaseService_ConsumerGroups")
    # ===================================================
